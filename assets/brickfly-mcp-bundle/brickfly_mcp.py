...
# Keep in sync with brickfly_mcp.addon_manager.EXPECTED_ADDON_PROTOCOL_VERSION.
ADDON_PROTOCOL_VERSION = 7

# Per-snapshot object cap for get_world_state_snapshot. Keep in sync with
# brickfly_mcp.trajectory.MAX_SNAPSHOT_OBJECTS.
...
# Keep in sync with brickfly_mcp.trajectory.MAX_SNAPSHOT_SELECTED.
...
class BLENDERMCP_PT_Panel(bpy.types.Panel):
    ...
    bl_region_type = 'UI'
    bl_category = 'Brickfly MCP for Blender'
